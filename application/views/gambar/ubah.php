        ...
        <div class="col-lg-9">
            <div class="card">
                <div class="card-block">
                    ...
                    <?= form_open_multipart('c_gambar/proses_ubah/'.$r->id_data_gbr) ?>
                    <div class="form-group">
                        <label >Nama</label>
                        <input type="text" class="form-control p-input" name="nama_gbr" placeholder="Nama" id="nama_gbr"  value="<?php echo $r->nama_gbr ?>" required>
                    </div>
                    <div class="form-group">
